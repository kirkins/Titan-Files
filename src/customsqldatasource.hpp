...
public:
    ...
    Q_INVOKABLE void load(const QString &query, const QVariantList &valuesByPosition);
     ...
     */
    Q_INVOKABLE QVariant executeAndWait (const QString &query, const QVariantList &valuesByPosition, int id = 1 );
     ...
     * @param An id that can be used to match requests
     */
    Q_INVOKABLE void execute (const QString &query, const QVariantList &valuesByPosition, int id = 1);
signals:
